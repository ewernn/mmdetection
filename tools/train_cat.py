...
def create_model(args, num_classes):
    ...
    anchor_sizes = (
        (72, 94),    # Smallest objects (unchanged)
        (84, 110),   # Small-medium objects
        (97, 129),   # Medium objects
        (113, 151),  # Medium-large objects
        (131, 177),  # Largest objects (15% larger)
    )
    aspect_ratios = ((0.67, 0.71, 0.76, 0.8, 0.87),) * len(anchor_sizes)
