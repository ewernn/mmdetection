...
# Read the CSV file
df = pd.read_csv('/Users/ewern/Desktop/code/MetronMind/c2/data/Test/Data.csv')
...
def annotate_images(df):
    ...
    while index < len(df):
        row = df.iloc[index]
        image_path = f"/Users/ewern/Desktop/code/MetronMind/c2/data/Testc/{row['Image']}"
...
df.to_csv('/Users/ewern/Desktop/code/MetronMind/c2/data/Test/Data_updated.csv', index=False)
