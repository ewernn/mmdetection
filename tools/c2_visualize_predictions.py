...
def create_model(device, num_classes):
    ...
    aspect_ratios = ((0.7, 0.9, 1.0, 1.1, 1.25, 1.5, 1.9, 2.4),) * len(anchor_sizes)
    ...
    # Apply modifications as in train_c2.py
    model.rpn.nms_thresh = 0.8
    model.rpn.fg_iou_thresh = 0.75
    model.rpn.bg_iou_thresh = 0.4
    model.roi_heads.batch_size_per_image = 64
    model.roi_heads.positive_fraction = 0.2
