...
def get_transform(train, args):
    ...
    if train:
        transforms.extend([
            ...
            AdjustBrightness(args.contrast_range),
...
# /Users/ewern/Desktop/code/MetronMind/data/cat-dataset
...
def create_model(args, num_classes):
    ...
    anchor_sizes = (
        (102, 136),  # Small objects
        (72, 94),    # Medium-small objects
        (114, 154),  # Medium objects
        (81, 109),   # Medium-large objects
        (92, 121),   # Large objects
    )
    aspect_ratios = ((0.87, 0.71, 0.64, 0.8, 0.76),) * len(anchor_sizes)
...
def parse_arguments():
    ...
    # parser.add_argument('--brightness_range', type=parse_tuple, default=(0.3, 1.5), help='Brightness adjustment range')
    # parser.add_argument('--contrast_range', type=parse_tuple, default=(0.3, 1.5), help='Contrast adjustment range')
